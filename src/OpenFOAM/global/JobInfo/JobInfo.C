    ...
    cpuTime_()
{
    ...
    {
        string baseDir;
        if(env("FREEFOAM_JOB_DIR"))
        {
            baseDir = getEnv("FREEFOAM_JOB_DIR");
        }
        else if(env("FOAM_JOB_DIR"))
        {
            baseDir = getEnv("FOAM_JOB_DIR");
        }
        else if(debug::controlDict().found("foamJobDir"))
        {
            debug::controlDict().lookup("foamJobDir") >> baseDir;
        }
        else
        {
            baseDir = home()/".FreeFOAM"/"jobControl";
        }
