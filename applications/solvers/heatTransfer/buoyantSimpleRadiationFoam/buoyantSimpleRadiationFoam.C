...
Usage
    - buoyantSimpleRadiationFoam [OPTION]
...
int main(int argc, char *argv[])
{
    ...
    #include "../buoyantSimpleFoam/createFields.H"
    ...
    while (runTime.loop())
    {
        ...
        #include "../buoyantSimpleFoam/initConvergenceCheck.H"
        ...
        {
            #include "../buoyantSimpleFoam/UEqn.H"
            #include "hEqn.H"
            #include "../buoyantSimpleFoam/pEqn.H"
        }
        ...
        #include "../buoyantSimpleFoam/convergenceCheck.H"
    }
